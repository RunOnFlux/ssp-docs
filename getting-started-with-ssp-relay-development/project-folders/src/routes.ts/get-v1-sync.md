---
description: Retrieve sync data using wallet identity id
---

# GET /v1/sync

<mark style="color:green;">`GET`</mark> **/v1/sync/{id}**&#x20;

**Path Params**

| Name | Value                     |
| ---- | ------------------------- |
| id   | walletIdentity to be sync |

**Request**

{% tabs %}
{% tab title="Curl" %}
<pre class="language-url"><code class="lang-url"><strong>curl --location 'https://relay.sspwallet.io/v1/sync/1Kys4uBjfqcb3DrtkAs8Gc8YXEmDmeFESd'
</strong></code></pre>
{% endtab %}
{% endtabs %}
...
{% tab title="404 - Sync Id does not exist" %}
```
Not Found
```
{% endtab %}
